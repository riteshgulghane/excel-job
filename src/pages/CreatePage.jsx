...
import { createRecord, isAuthenticated } from '../services/googleSheetsService';
...
const CreatePage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast('Failed to create record. Please try again.', 'error');
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">Add a new entry to your Google Sheet</p>
      </div>

      {/* Auth Info - Show only if not authenticated */}
      ...
      <div className="card bg-gray-50">
        ...
        <ul className="text-sm text-gray-600 space-y-1 list-disc list-inside">
          ...
          <li>The Sr No will be auto-generated</li>
          <li>Data will be saved directly to your Google Sheet</li>
        </ul>
      </div>
